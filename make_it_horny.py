...
HORIZONTAL_GENERATOR_PATH = "./assets/json/generator/make_it_horny/make_it_horny_h.soju.json"
VERTICAL_GENERATOR_PATH = "./assets/json/generator/make_it_horny/make_it_horny_v.soju.json"
BOT_COMMAND_NAME = "Make it Horny"
