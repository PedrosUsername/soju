...
HORIZONTAL_GENERATOR_PATH = "./assets/json/generator/make_it_scary/make_it_scary_h.soju.json"
VERTICAL_GENERATOR_PATH = "./assets/json/generator/make_it_scary/make_it_scary_v.soju.json"
BOT_COMMAND_NAME = "Make it Scary"
